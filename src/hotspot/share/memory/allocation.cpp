...
ResourceObj::ResourceObj() : _type(_thread_last_allocated) {
  _thread_last_allocated = STACK_OR_EMBEDDED;
}

ResourceObj::ResourceObj(const ResourceObj&) : _type(_thread_last_allocated) {
  _thread_last_allocated = STACK_OR_EMBEDDED;
}
