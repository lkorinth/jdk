...
class RefTask : public AbstractGangTask {
protected:
...
class RefProcPhase1Task : public RefTask {
public:
  RefProcPhase1Task(ReferenceProcessor&           ref_processor,
                    ReferenceProcessorPhaseTimes* phase_times,
                    ReferencePolicy*              policy,
                    AbstractClosureContext&       closure_context)
  : RefTask("RefProcPhase1Task",
            ref_processor,
            phase_times,
            closure_context),
    _policy(policy) { }
...
class RefProcPhase2Task: public RefTask {
...
class RefProcPhase3Task: public RefTask {
public:
  RefProcPhase3Task(ReferenceProcessor&           ref_processor,
                    ReferenceProcessorPhaseTimes* phase_times,
                    AbstractClosureContext& closure_context)
    : RefTask("RefProcPhase3Task",
              ref_processor,
              phase_times,
              closure_context) { }
...
class RefProcPhase4Task: public RefTask {
public:
  RefProcPhase4Task(ReferenceProcessor&           ref_processor,
                    ReferenceProcessorPhaseTimes* phase_times,
                    AbstractClosureContext&       closure_context)
    : RefTask("RefProcPhase4Task",
              ref_processor,
              phase_times,
              closure_context) { }
...
void ReferenceProcessor::execute(AbstractGangTask& task, AbstractClosureContext& closure_context, bool marks_oops_alive) {
  ...
  closure_context.begin(num_queues(), processing_is_mt() ? ThreadModel::Multi : ThreadModel::Single, marks_oops_alive);
...
void ReferenceProcessor::process_soft_ref_reconsider(AbstractClosureContext& closure_context,
  ...
  execute(phase1, closure_context, true);
...
void ReferenceProcessor::process_soft_weak_final_refs(AbstractClosureContext& closure_context,
  ...
  execute(phase2, closure_context, false);
...
void ReferenceProcessor::process_final_keep_alive(AbstractClosureContext& closure_context,
  ...
  execute(phase3, closure_context, true);
...
void ReferenceProcessor::process_phantom_refs(AbstractClosureContext& closure_context,
  ...
  execute(phase4, closure_context, false);
