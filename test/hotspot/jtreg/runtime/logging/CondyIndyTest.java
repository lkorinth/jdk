...
public class CondyIndyTest {
    public static void main(String... args) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "-Xlog:methodhandles",
                                                                  "CondyIndy");
        ...
        pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "-Xlog:methodhandles+condy=debug",
                                                   "CondyIndy");
        ...
        pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "-Xlog:methodhandles+indy=debug",
                                                   "CondyIndy");
        o = new OutputAnalyzer(pb.start());
        o.shouldHaveExitValue(0);
        o.shouldNotContain("[info ][methodhandles");
        ...
        pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "-Xlog:methodhandles=info",
