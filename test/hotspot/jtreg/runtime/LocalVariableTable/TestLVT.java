...
public class TestLVT {
    public static void main(String[] args) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "DuplicateLVT");
        new OutputAnalyzer(pb.start())
            .shouldContain("Duplicated LocalVariableTable attribute entry for 'by' in class file DuplicateLVT")
            .shouldHaveExitValue(1);

        pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "DuplicateLVTT");
        new OutputAnalyzer(pb.start())
            .shouldContain("Duplicated LocalVariableTypeTable attribute entry for 'list' in class file DuplicateLVTT")
            .shouldHaveExitValue(1);

        pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "NotFoundLVTT");
        new OutputAnalyzer(pb.start())
