...
public class XCheckJSig {
    public static void main(String args[]) throws Throwable {
        ...
        ProcessBuilder pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "-Xcheck:jni", "-version");
        ...
        pb = ProcessTools.createJavaProcessBuilder(IgnoreTestJavaOpts, "-Xcheck:jni", "-verbose:jni", "-version");
        env = pb.environment();
        env.put(env_var, libjsig);
